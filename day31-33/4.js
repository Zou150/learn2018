    ...
    //         regionCheckbox = regionX.querySelectorAll('input:checked'),
    //         productCheckbox = productX.querySelectorAll('input:checked'),
    //         string = "<table border=\'1\'><thead><tr>",
    //         count = 0;
        
    //     if(regionCheckbox.length >= productCheckbox.length) {
    //         string = string.concat('<th>商品</th><th>地区</th>');
    //     }else {
    //         string = string.concat('<th>地区</th><th>商品</th>');
    //         count += 1;
    //     }
    //     console.log(count)
